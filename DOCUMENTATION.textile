...
p. All this examples are generated in spec/readme/technical_readme_spec.rb . Only difference
is image filename.
...
p. In this documentation I lowered default graph size so it looks nicer here. If you
would like to do this insert something like this at the beginning of your code:
...
file_name = '11_renderer_rmagick.png'
@tg.save_to_file(file_name)
...
file_name = '11_renderer_rasem.png'
@tg.save_to_file(file_name)
</code>
</pre>

...
Gem::Specification.new do |s|
  ...
  s.date = "2012-05-26"
  s.description = "Purpose of this gem is to create neat, simple, technical graphs. This is alternative to most new libraries which create small, candy graphs using JavaScript."
  ...
  s.summary = "Create simple and neat graphs"
